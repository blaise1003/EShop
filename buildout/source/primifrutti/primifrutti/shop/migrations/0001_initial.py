...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('shop_offer', (
            ...
            ('main_description', self.gf('django.db.models.fields.TextField')()),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=100)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('picture', self.gf('satchmo_utils.thumbnail.field.ImageWithThumbnailField')(name_field='_filename', max_length=512)),
        ))
        db.send_create_signal('shop', ['Offer'])

        # Adding model 'Banner'
        db.create_table('shop_banner', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal('shop', ['Banner'])

        # Adding model 'ProductFeaturedSorting'
        db.create_table('shop_productfeaturedsorting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product.Product'])),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=100)),
        ))
        db.send_create_signal('shop', ['ProductFeaturedSorting'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('shop_banner')

        # Deleting model 'ProductFeaturedSorting'
        db.delete_table('shop_productfeaturedsorting')
    ...
    models = {
        ...
        'shop.banner': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'picture': ('satchmo_utils.thumbnail.field.ImageWithThumbnailField', [], {'name_field': "'_filename'", 'max_length': '512'}),
        ...
        'shop.offer': {
            'Meta': {'ordering': "['ordering', 'title']", 'object_name': 'Offer'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_description': ('django.db.models.fields.TextField', [], {}),
        ...
        'shop.productfeaturedsorting': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'ProductFeaturedSorting'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '100'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['product.Product']"})
        },
